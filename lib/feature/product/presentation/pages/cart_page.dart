                          ...
                          children: [
                            Padding(
                              ...
                              child: ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount: CartDataProvider.items.length,
                                  itemBuilder: (context, index) {
                                    debugPrint(
                                        '${CartDataProvider.items.length}');
                                    if (CartDataProvider.items.isEmpty) {
                                      return Container();
                                    } else{
                                      return CartItemsWidget(
                                        images: CartDataProvider.items[index].images,
                                        price: CartDataProvider.items[index].price,
                                        title: CartDataProvider.items[index].title,
                                        color: CartDataProvider.items[index].color,
                                        id: CartDataProvider.items[index].id,
                                      );
                                    }
                                  }),
                            ),
